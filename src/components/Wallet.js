    ...
    <section className='bg-gray-100 text-gray-900 min-h-screen'>
      {
        user && user.emailVerified
          ...
          :
          <div className='flex justify-center align-middle pt-60'>
            <div>
              <p className='text-3xl text-center'>Please Verify Your Email.</p>
              <br />
              <p className='text-3xl text-center'>Verification Link Has Been Sent to Your Email Address</p>
            </div>
          </div>
